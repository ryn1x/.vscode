...
class GhciManager {
    ...
    start() {
        return __awaiter(this, void 0, void 0, function* () {
            this.checkDisposed();
            this.proc = child_process.spawn(this.command, Object.assign({}, this.options, { stdio: 'pipe', shell: true }));
    ...
    _sendCommand(commands, config = {}) {
        return new Promise((resolve, reject) => {
            ...
            const pending = Object.assign({}, nullConfig, config, { commands, resolve, reject });
